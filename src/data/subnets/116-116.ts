...
// SN116 is currently unnamed / dormant on the registry. No public site,
...
export const sn116: RichSubnet = {
  slug: '116-116',
  netuid: 116,
  name: 'Subnet 116',
  shortPitch: 'Bittensor subnet 116 — no public identity or specification yet.',
  overview: [
    'Subnet 116 is registered on the Bittensor metagraph but has no public name, website, GitHub repository, or operator identity discoverable as of May 2026. The slot exists in the registry; the content does not.',
  ...
  scoring: { leadOneLine: 'No scoring rules published.', explanation: ['Subnet 116 has not published a scoring specification, a reference miner client, or a validator client as of May 2026.', 'The slot exists on the metagraph; the operator has not yet identified themselves publicly.'], cheatPath: 'Not applicable — no live workload to grade.' },
  customer: { leadOneLine: 'No published customer or use case.', explanation: ['No commercial pitch, marketing site, or product surface exists for subnet 116 as of May 2026.', 'Without a published specification, there is no buyer persona to describe.'] },
  competitive: { scope: '2026 · undefined', rows: [
    { name: 'Subnet 116', subtitle: 'SN116', isSelf: true, approach: 'No published approach', access: 'unknown', accessTone: 'closed', differentiator: 'No published differentiator' },
  ], note: 'No competitive positioning is possible until the operator publishes a specification.' },
  team: { intro: ['No public team information available for subnet 116 as of May 2026.', 'The slot is registered but no operator identity has been disclosed.'], founders: [{ initials: '116', gradient: 'g', name: '[Founder 1 name]', role: 'Operator', bio: 'Operator identity not publicly disclosed.' }], size: 'Not publicly disclosed.', founded: 'Unknown', based: 'Unknown', backers: 'Not publicly disclosed.', placeholder: true },
  milestones: [{ date: '2026·05', text: 'No public milestones — subnet 116 has no published identity yet.' }],
  join: { title: 'Wait for the operator to surface', body: 'No public mining or validation specification has been released for subnet 116. Watch the taostats page for updates.', asideNote: 'Last checked May 2026.' },
  tags: [],
  external: { taostats: 'https://taostats.io/subnets/116/' },
};
