...
// SN116 — dormant. No public name, repo, site, or operator as of June 2026.

export const sn116: RichPlaybook = {
  slug: '116-116',
  netuid: 116,
  name: 'Subnet 116',
  category: 'compute',
  ...
  rentalOk: true,
  repo: { url: 'https://taostats.io/subnets/116/', branch: 'main', minerEntrypoint: 'TBD' },
  ...
  install: [{ step: 'No public install steps', note: 'Subnet 116 has no published miner client.' }],
  ...
  monitoring: [{ metric: 'Operator activity', threshold: 'any public surface', where: 'taostats.io/subnets/116' }],
